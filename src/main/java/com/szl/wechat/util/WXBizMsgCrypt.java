...
public class WXBizMsgCrypt {
	...
	public WXBizMsgCrypt(String token, String encodingAesKey, String appId) throws AesException {
		this.token = token;
		this.appId = appId;
		if (StringUtils.isNotNull(encodingAesKey)) {
	 ...
	 *             执行失败，请查看该异常的错误码和具体的错误信息
	 */
	public String verifyUrl(String msgSignature, String timeStamp, String nonce, String echoStr, boolean encryptFlag)
			throws AesException {
	...
	public boolean verifySign(String msgSignature, String timeStamp, String nonce) {
		String signature = SHA1.getSHA1(token, timeStamp, nonce, null);
